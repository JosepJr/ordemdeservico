...
import stateeditar.EditarNivelServicoSelecionadoState;
...
import statevisualizar.VisualizarNivelServicoSelecionadoState;
...
public class ManterOrdemServicoPresenter {
    ...
    private ManterOrdemServicoState state;
    ...
    private void setState(ManterOrdemServicoState state) {
        this.state = state;
    }

    public void incluir(int indice, OrdemServico os) {
        if (indice == 0) {
            this.setState(new IncluirOrdemServicoState(this));
            this.state.incluir(os);
        }
        if (indice == 1) {
            this.setState(new IncluirSituacaoOrdemServicoState(this));
    ...
    public void visualizar(int indice, OrdemServico os, Object ob1, Object ob2) {
        ...
        if(indice == 3){
            ...
            this.setState(new VisualizarNivelServicoSelecionadoState(this));
            this.state.visualizar(os, ob1, null);
        }
    }
    ...
    public void editar(int indice, OrdemServico os, Object ob1, Object ob2) {
        ...
        if (indice == 4) {
            this.setState(new EditarNivelServicoSelecionadoState(this));
            this.state.editar(os, ob1, null);
        }
    }
